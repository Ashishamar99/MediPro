...
const handleDoctorLogin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        return res
            .status(500)
            .json({ status: status_1.Status.ERROR, message: err });
    }
});
...
const handleDoctorRegister = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        doctor = yield handleFileUpload({ file: req.file, body: req.body });
...
const handleFileUpload = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const { user } = req.body;
    const filename = `${Date.now().toString()}-${req.file.originalname}`;
    const data = yield (0, helper_1.uploadFileToSupabase)(filename, req.file.buffer);
